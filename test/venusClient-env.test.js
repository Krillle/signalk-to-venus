...
describe('VenusClient - Environment', () => {
  ...
  describe('Device Naming', () => {
    ...
    it('should handle unknown environment types gracefully', () => {
      ...
      expect(client._getEnvironmentName('environment.custom.customSensor')).toBe('Custom Custom Sensor');
      expect(client._getEnvironmentName('invalid.path')).toBe('Unknown Environment Sensor');
    });
  });
